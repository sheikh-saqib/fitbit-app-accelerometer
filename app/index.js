...
function simAccelTick() {  // fake data - used when running in Fitbit Simulator to simulate accel readings
  ...
  console.error("simAccelTick recording")
  ...
  for (let index = 0; index<batchSize; index++) {
    ...
    let accelX = (simAccelReading++) & 0xFFFF;
    let accelY = (simAccelReading++) & 0xFFFF;
    let accelZ = (simAccelReading++) & 0xFFFF;
    dataBufferView[bufferIndex++] = accelX;
    dataBufferView[bufferIndex++] = accelY;
    dataBufferView[bufferIndex++] = accelZ;
    console.log(`Accelerometer reading: x=${accelX}, y=${accelY}, z=${accelZ}`);
  }
